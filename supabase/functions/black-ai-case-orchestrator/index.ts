...
import {
  ...
  filterAndRankCatalogProducts,
  mergeCommercialPreferences,
  normalizeCommercialPreferences,
  preferenceSummary,
  productBrand,
  searchableProductText,
} from "../_shared/black-ai-commercial-engine.ts";

const BUILD_ID = "black-ai-case-orchestrator-20260915-commercial2";
